...
[task_local]
#领京豆额外奖励
10 7 * * * https://raw.githubusercontent.com/ZFeng3242/JD-haoyangmao/main/scripts/jd_bean_home.js, tag=领京豆额外奖励, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_bean_home.png, enabled=true

================Loon==============
[Script]
cron "10 7 * * *" script-path=https://raw.githubusercontent.com/ZFeng3242/JD-haoyangmao/main/scripts/jd_bean_home.js, tag=领京豆额外奖励
...
============小火箭=========
领京豆额外奖励 = type=cron,script-path=https://raw.githubusercontent.com/ZFeng3242/JD-haoyangmao/main/scripts/jd_bean_home.js, cronexpr="10 7 * * *", timeout=200, enable=true
 */
...
function getAuthorShareCode() {
  return new Promise(resolve => {
    $.get({url: "https://gitee.com/ZFeng3242/updateTeam/raw/main/jd_bean_home",headers:{
...
function getAuthorShareCode2() {
  return new Promise(resolve => {
    $.get({url: "https://gitee.com/ZFeng3242/updateTeam/raw/master/jd_updateBeanHome.json",headers:{
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
      }}, async (err, resp, data) => {
      try {
        if (err) {
